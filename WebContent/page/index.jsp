  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">学生就业</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;">超级管理员</a></li>
				<li class="header-bar-nav">
				<c:if test="${sessionScope.Users != null }">
					<a href="javascript:;">${sessionScope.Users.username }<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a href="../logout.do">退出</a></li>
					</ul>
				</c:if>
				<c:if test="${sessionScope.Users == null }">
					<a href="javascript:;">欢迎<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
